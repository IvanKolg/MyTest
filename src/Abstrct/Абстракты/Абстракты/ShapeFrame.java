...
import Abstrct.Абстракты.Абстракты.OvalComponent;
import Abstrct.Абстракты.Абстракты.RectangleComponent;
import Abstrct.Абстракты.Абстракты.TriangleComponent;
